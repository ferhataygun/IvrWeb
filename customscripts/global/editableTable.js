$(document).ready(function(){
  window.TableDatatablesEditable = function (domid,btnid) {

    function handleTable(domid,btnid){
    ...
    handleTable(domid,btnid);

  }

  window.TableDatatablesEditable2 = function (domid,btnid) {
